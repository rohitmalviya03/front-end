...
export default function SellerRegistration() {
                        ...
                        <form action="sellerreg" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control"  name="lastName" id="last_name" value="" required />
                                </div>
                                ...
                                <div class="col-12 mb-3">
                                  ...
                                  <div class="col-12 mb-3">
                                    ...
                                    <select class="w-100" id="country" name="category">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="text" name="pincode" class="form-control" id="postcode" value="" />
                                </div>
                                <div class="col-12 mb-3">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="number" name="phoneNumber" class="form-control" id="phone_number" min="0" value="" />
                                </div>
 ...
 <div class="col-12 mb-4">
                                    ...
                                    <input type="password" name="password" class="form-control" id="email_address" value="" />
                                </div>
                                <div class="col-12">
